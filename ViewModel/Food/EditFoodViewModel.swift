...
class EditFoodViewModel: ObservableObject {
    // MARK: - PROPERTIES
    @Published var didUpdateFood = false
    ...
    // MARK: - METHODS
    @MainActor
    func updateFood(id: Int, title: String, calories: String, carbs: String, fibers: String, fat: String, protein: String, estimates: String) async throws {
        guard let user = AuthViewModel.shared.currentUser else { return }
        guard let url = URL(string: "http://127.0.0.1:8000/api/food/foods/\(id)/") else {
